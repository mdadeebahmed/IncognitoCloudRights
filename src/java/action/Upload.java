                    ...
                    while (it.hasNext()) {
                        ...
                        if (isFormField) {
                            ...
                            try {
                                ...
                                String cipher1 =new TrippleDes().encrypt(cipher);
                                //for get extension from given file
                                String fextension = fileItem.getName().substring(fileItem.getName().lastIndexOf('.'));
                                System.out.println("File Extension" + fextension);
                                pstm.setInt(1, fid1);
                                pstm.setBinaryStream(2, fileItem.getInputStream());
                                pstm.setString(3, fextension);
                                pstm.setString(4, fname);
                                pstm.setDate(5, getCurrentDate());
                                pstm.setString(6, email);
                                pstm.setLong(7, fileItem.getSize());
                                pstm.setString(8, cipher1);
